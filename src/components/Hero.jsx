...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-[700px] h-[700px] bg-purple-600/20 blur-[180px] rounded-full" />

      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-blue-600/20 blur-[180px] rounded-full" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              ...
              <a
                href="/resume.pdf"
                download="Frontend Developer - Aaqib Javaid.pdf"
                className=" px-8 py-4 rounded-xl border border-slate-700 hover:border-purple-500
          ...
          <div className="relative flex justify-center z-20">
            ...
            <div className="absolute w-[450px] h-[450px] bg-gradient-to-r from-purple-500 to-blue-500 rounded-full blur-[100px] opacity-30" />
            ...
            <div className="absolute top-16 left-0 bg-slate-900/90 backdrop-blur-xl border border-purple-500/20 rounded-2xl px-4 py-3 shadow-xl">
            ...
            <div className="absolute top-40 right-0 bg-slate-900/90 backdrop-blur-xl border border-yellow-500/20 rounded-2xl px-4 py-3 shadow-xl">
              <div className="flex items-center gap-2">
            ...
            <div
              className="
    absolute bottom-20 left-4 md:left-12 lg:left-20 bg-slate-900/90 backdrop-blur-xl border  border-cyan-500/20 rounded-2xl px-4 py-3 shadow-xl z-20
  "
            >
              <div className="flex items-center gap-2">
